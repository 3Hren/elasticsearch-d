...
class IndexRequestTestCase : BaseTestCase!IndexRequestTestCase {
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?version=1", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?op_type=create", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?routing=kimchi", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?parent=1111", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?timestamp=2009-11-15T14%3A12%3A12", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?ttl=86400000", request.uri);
    }
    ...
    unittest {
        ...
        Assert.equals("/index/type/id?timeout=5m", request.uri);
    }
}
